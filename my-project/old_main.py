...
class BaseTransformationScene(Scene):
    ...
    def setup(self):
        ...
        # self.area_under_curve.add_updater(update_area)
...
class HorizontalTransformationScene(BaseTransformationScene):
    def setup(self):
        ...
        # axes_config["x_length"] = 8

        # graph_config = self.graph_config.copy()
        # graph_config["x_range"] = [0, plot_length]
        # print(f"{plot_length}")
    ...
    def construct(self):
        ...
        self.play(
            ...
            Transform(
                self.transformation_notation[self.d_index],
                MathTex("-2)")
                .set_color(RED)
