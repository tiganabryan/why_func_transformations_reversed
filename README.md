...
The idea that certain math operations done to functions appear "reversed" isn't just an off-hand fact to memorize; how we define coordinate systems is at the core of how we describe physical phenomena.
